...
svgEditor.addExtension("view_grid", function(s) {
		 ...
		 */
		var gridConfig = { 
							'1x1': { height: 1, width: 1, color: '#000', strokeWidth: 0.05, opacity: 0.1 },
							'5x5': { height: 5, width: 5, color: '#000', strokeWidth: 0.2, opacity: 0.2 },
							'10x10': { height: 10, width: 10, color: '#000', strokeWidth: 0.2, opacity: 0.3 },
							'100x100': { height: 100, width: 100, color: '#000', strokeWidth: 0.2, opacity: 0.5 }
						  };
