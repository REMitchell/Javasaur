	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPreflas = {
			...
			curConfig = {
				...
				langPath: 'locale/',
				extPath: 'extensions/',
				extensions: ['ext-markers.js','ext-connector.js', 'ext-eyedropper.js', 'ext-createElement.js', 'ext-animate.js'],
				initTool: 'select',
				wireframe: false
			},
			uiStrings = {
...
// 				if(color == curPrefs.bkgd_color && url == curPrefs.bkgd_url) return;
            ...
            var hideAnimationProperties = function(){
                $('#animationProperties').hide();
            };
